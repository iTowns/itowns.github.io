...
Shaders["pointcloud.vs"] = `precision highp float;
precision highp int;
...
Shaders["normalize.fs"] = `#include <potree/WebGL2_pars_fragment>
#include <logdepthbuf_pars_fragment>
...
Shaders["normalize_and_edl.fs"] = `#include <potree/WebGL2_pars_fragment>
#include <logdepthbuf_pars_fragment>
...
Shaders["edl.vs"] = `#include <potree/WebGL2_pars_vertex>
#include <common>
#include <logdepthbuf_pars_vertex>
...
Shaders["edl.fs"] = `precision mediump float;
precision mediump int;
#include <potree/WebGL2_pars_fragment>
#include <logdepthbuf_pars_fragment>
...
Shaders["WebGL2_pars_vertex.vs"] = `// Copy from GLSL 3.0 conversion for built-in materials and ShaderMaterial in THREE.WebGLProgram
...
#elif defined USE_LOGDEPTHBUF_EXT
	#extension GL_EXT_frag_depth : enable
#endif
`

Shaders["WebGL2_pars_fragment.fs"] = `// Copy from GLSL 3.0 conversion for built-in materials and ShaderMaterial in THREE.WebGLProgram
// https://github.com/mrdoob/three.js/blob/696d7836d1fc56c4702a475e6991c4adef7357f4/src/renderers/webgl/WebGLProgram.js#L682
#if defined(WEBGL2)
#define varying in
