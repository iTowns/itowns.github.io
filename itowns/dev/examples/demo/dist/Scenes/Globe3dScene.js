...
export const Globe3dScene = {
  title: 'Explore the World in 3D',
  description: 'Visualize the Earth in 3D with high-resolution orthophoto imagery. ' + 'Navigate freely around the globe with intuitive controls.',
  placement: {
