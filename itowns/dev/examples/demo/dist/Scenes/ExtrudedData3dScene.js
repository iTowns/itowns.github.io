...
export const ExtrudedData3dScene = {
  title: 'Build Cities in Seconds',
  description: 'Bring your city to life by extruding building footprints ' + 'based on height attributes. Create realistic urban landscapes in real-time.',
  placement: {
