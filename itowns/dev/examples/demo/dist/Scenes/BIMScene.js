...
export const BIMScene = {
  title: 'From Building to Territory',
  description: 'Integrate Building Information Models into your geospatial context. ' + 'Load glTF models to combine architectural and geographic data.',
  placement: {
