...
export const Terrain3dScene = {
  title: 'Feel the Relief',
  description: 'Add realistic relief to your maps with elevation data. ' + 'iTowns supports multiple terrain formats such as WMTS with images and COG.',
  placement: {
