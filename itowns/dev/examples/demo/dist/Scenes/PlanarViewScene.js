...
import { PlanarView } from "../Views/index.js";
...
const extent = new itowns.Extent('EPSG:2154', 834594.0, 854594, 6509549.0, 6529549.99);
export const PlanarViewScene = {
  title: 'Go Local',
  description: 'Seamlessly transition between global and local coordinate systems. ' + 'Support for national projections like Lambert-93 (EPSG:2154).',
  placement: {
