...
export const TexturedMeshes3dScene = {
  title: 'Stream Entire Cities',
  description: 'Load and navigate detailed 3D city models using 3D Tiles. ' + 'Stream only what you need for optimal performance.',
  placement: {
